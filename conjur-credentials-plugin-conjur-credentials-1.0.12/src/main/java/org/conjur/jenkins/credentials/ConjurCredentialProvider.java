...
public class ConjurCredentialProvider extends CredentialsProvider {
    ...
    private <C extends Credentials> List<C> getCredentialsFromSupplier(@Nonnull Class<C> type,
        ...
        if (!type.isInstance(CertificateCredentials.class) && (
            ...
            {
            	 LOGGER.log(Level.FINE, "**** getCredentials ConjurCredentialProvider: else part" + this.getId() + " : " + this );
                 LOGGER.log(Level.FINE, "Getting Credentials from ConjurCredentialProvider @ else part" + context.getClass().getName());
    ...
    public ConjurCredentialStore getStore(ModelObject object) {
        ...
        if (object == Jenkins.get()) {
        	LOGGER.log(Level.FINE,"jenkins get object"+object);
            return null;
        }
        ...
        if (object != null) {
            ...
            LOGGER.log(Level.FINE,"Object not null"+object.getDisplayName()+"Key"+key.toString());
            ...
            if (ConjurCredentialStore.getAllStores().containsKey(key)) {
                ...
                LOGGER.log(Level.FINEST,"inside if to get key"+store.getContextDisplayName());
            ...
            LOGGER.log(Level.FINE,"currentCredentialSupplier"+currentCredentialSupplier.get());
            }
            catch(Exception ex)
            {
